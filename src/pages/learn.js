...
const IndexPage = ({
  ...
  return <Layout><PageNavigation sections={edges.map(edge => edge.node.frontmatter)} /><Banner title="Learn" subtitle="" content="Worker cooperatives are the better way to do business."/>{Sections}</Layout>
}
